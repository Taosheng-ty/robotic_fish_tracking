...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        self.add_class("shapes", 1, "fish") # 黑色素瘤
        ...
        for i in range(count):
            ...
            mask_path = img_floder + "/" + filestr + '/' + "label.png"
            yaml_path = img_floder + "/" + filestr + '/' + "info.yaml"

            print(dataset_root_path + "labelme_json/" + filestr + "_json/img.png")
            cv_img = cv2.imread(img_floder + "/" + filestr + '/' + "img.png")

            self.add_image("shapes", image_id=i, path=img_floder + "/" + filestr + '/' + "img.png",
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("fish") != -1:
                # print "box"
                labels_form.append("fish")
